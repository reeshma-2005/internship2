...
import DisplayAdjustment from "./components/inventory/DIsplayAdjustment";
import DisplaySalesOrders from "./components/SalesModule/DisplaySalesOrders";
import DisplayPurchaseOrders from "./components/vendormodule/DisplayPurchaseOrders";
import AddPurchaseOrder from "./components/vendormodule/AddPurchaseOrder";
function App() {
  return (
    ...
    <Routes>
       ...
       <Route path="/displayadjustments" element={<DisplayAdjustment/>}/>
       <Route path="/displaysalesorders" element={<DisplaySalesOrders/>}/>
       <Route path="/purchaseorderpage" element={<AddPurchaseOrder/>}/>
       <Route path="/displaypurchaseorders" element={<DisplayPurchaseOrders/>}/>
    </Routes>
    </BrowserRouter>
